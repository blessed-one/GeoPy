...
namespace Infrastructure.Database.Migrations
{
    ...
    [Migration("20250728060225_Add_Future_Date_Check_To_Wells")]
    partial class Add_Future_Date_Check_To_Wells
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.Well", b =>
                {
                    ...
                    b.ToTable("wells", null, t =>
                        {
                            t.HasCheckConstraint("ck_well_measurement_date_not_future", "\"measurement_date\" <= CURRENT_DATE");
                        });
                });
